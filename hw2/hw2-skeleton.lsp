...
(defun BFS (FRINGE)
    (cond	((null FRINGE) nil)
		...
		(T (cond	((atom (second FRINGE)) (cons (second FRINGE) (BFS (append (cons (car FRINGE) nil) (cddr FRINGE)))))
				(T (BFS (append (cons (append (car FRINGE) (second FRINGE)) nil) (cddr FRINGE))))
			)
		)
	)
)
